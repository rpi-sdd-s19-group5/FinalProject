...
#Funtion returns string of a given web page title
def get_name(driver):
    name = []
    try:
        ...
        print("get_name fail to get title text from {}".format(dirver))
    return name
...
def get_page(driver):
    ...
    for im in im_word:
        try:
            ...
            print("get_page fail to get title text from {}".format(dirver))
    return ans
...
def get_image(driver):
    ...
    for i in image:
        ...
        try:
            ...
            print("get_image fail to get image address from {}".format(dirver))
    return ans
...
#Wrapper function that collect all information from a single prfessor page
def get_people(url):
    try:
